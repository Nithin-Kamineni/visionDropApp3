...
import { CAPTURE_BUTTON_SIZE, SCREEN_HEIGHT, SCREEN_WIDTH } from '../Screens/Camera/Constants'
...
interface Props extends ViewProps {
  ...
  startSequence: (paramFunction: () => void) => void;
  stopSequence: (paramFunction: () => void) => void;
}
      ...
      switch (event.state) {
        ...
        case State.CANCELLED: {
          ...
          try {
            ...
            } else if (isPressingButton.value === true) {
              isPressingButton.value = false;
              setIsPressingButton(false);
              await stopSequence(() => {
                isPressingButton.value = false;
...
export const SequenceButton = React.memo(_CaptureButton);
